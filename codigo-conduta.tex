...
\begin{conduta}
  ...
  \item Participem das discussões, deliberações e votações do grupo de maneira honesta e aberta
\end{conduta}

%--- Seção 9: Alinhamento com Software Livre --------------------------------
\section{Alinhamento com Software Livre}

Este grupo orienta-se pelos princípios do \textit{software} livre e código aberto, promovendo:
