...
\lettrine[lines=3, lhang=0.1, nindent=0em, slope=-0.5em]{O}{ presente} documento formaliza a criação do Grupo de Usuários Linux e Software Livre em 
...
uso de sistemas baseados em Linux, software livre e práticas abertas no contexto da ciência de dados, estatística e computação científica.
...
maturidade do ecossistema de software livre como infraestrutura essencial para pesquisa, ensino e inovação. Nesse sentido, estabelece-se como um 
...
Promover o uso, estudo e desenvolvimento de tecnologias baseadas em Linux e software livre no âmbito da Estatística e Ciência de Dados, 
...
O grupo orienta-se pelos princípios estabelecidos em seu Manifesto, que define os valores centrais relacionados à ciência aberta, software livre, 
...
O grupo constitui-se como uma organização acadêmica informal, sem fins lucrativos, de caráter colaborativo e voluntário, vinculada à comunidade 
...
execução coordenada das atividades, o grupo contará com uma Coordenação, composta por membros eleitos por meio de processo eleitoral periódico.
...
gestão dos canais e infraestrutura, mediação de questões administrativas e apoio à coordenação de projetos. 
A atuação da Coordenação deverá observar os princípios de transparência, prestação de contas e alinhamento com os 
valores do grupo, não implicando privilégio técnico ou científico sobre os demais membros, mas sim responsabilidade funcional e organizacional.
...
Projetos desenvolvidos no âmbito do grupo deverão, preferencialmente, adotar licenças de software livre e código aberto, 
garantindo liberdade de uso, modificação e distribuição, salvo quando explicitamente acordado de forma distinta entre os envolvidos.
